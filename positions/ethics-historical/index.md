...
# Philosophical Positions — Ethics: Historical Perspectives (PY1095)
...
The course is primarily about the historical philosophers themselves. Each position here is **additive**: it sharpens or extends the discussion of the named historical philosopher with a contemporary critique. The exam essay's spine remains the historical text; the position enters as a modern deepening, not as a replacement for engagement with the primary source. Tone is respectful — rivals get a fair hearing.
...
**Applicable to:** Mill's conception of happiness, hedonism, qualitative hedonism, higher and lower pleasures, swine objection, competent judges, experience machine, intrinsic value of pleasure, does Mill remain a hedonist, preference utilitarianism, *ethics-historical / 5. Mill*

## Against Strict Impartialism; Against Pure Agent-Relativity
`file: against-strict-impartialism.md`

**Applicable to:** impartiality in Mill, strictly impartial spectator, demandingness objection, demandingness in utilitarianism, shallow pond argument, Singer on charity, agent-relative value, agent-neutral value, ethical egoism, partiality and special obligations, what moves us to act for the sake of happiness in others, *ethics-historical / 5. Mill*

## Justice Resists Utilitarian Reduction
`file: justice-resists-utility.md`
...
## Rule Utilitarianism Doesn't Solve the Counter-example Problem
`file: against-rule-utilitarianism.md`

**Applicable to:** act utilitarianism, rule utilitarianism, act vs rule utilitarianism, was Mill an act- or rule-utilitarian, exception clauses in rules, generality of rules, exceptionless rules, rule utilitarian reply to organ harvesting, *ethics-historical / 5. Mill*

## The Universal Law Formula Has Real Bite, but Kant's Absolutism on Lying Is Untenable
`file: universal-law-formula.md`
